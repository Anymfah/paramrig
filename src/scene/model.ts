...
export function sanitizeSceneView(value: unknown): ViewState {
...
export function sanitizeSceneDocument(value: unknown): SceneDocument | null {
  ...
  return {
    ...
    view: sanitizeSceneView(source.view),
    units: {
...
export function sceneDocumentKey(id: string): string { return id.slice(0, MAX_ID_LENGTH) }
