...
export const SCENE_ICONS: Record<string, SceneIconComponent> = {
  ...
  'modifier-bevel': Icons.IconBevelModifier,
  'modifier-triangulate': Icons.IconTriangulate,
  'modifier-weld': Icons.IconWeld,
  'modifier-smooth': Icons.IconSmoothModifier,
  'modifier-cast': Icons.IconCast,
  'modifier-edge-split': Icons.IconEdgeSplit,
  'modifier-edit-mode': Icons.IconInEditMode,
  'modifier-on-cage': Icons.IconOnCage,
