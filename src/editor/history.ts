/** A saved state of a document, as the history panel lists it. */
export type NamedVersion = { id: string; name: string; createdAt: string }
 ...
 */
export function historyRows(steps: HistoryStep[], current: number, versions: NamedVersion[] = []): HistoryRow[] {
