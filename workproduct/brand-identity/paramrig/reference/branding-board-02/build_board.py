...
signature(64, 45, 176)
label('VISUAL IDENTITY / 02', 1118, 61)
line(64, 96, 1536, 96)
...
artwork('paramrig-coform-symbol.svg', 1120, 425, 240, PAPER)
...
label('02 / MONOCHROME PALETTE', 64, 824)
...
svg = ('<svg xmlns="http://www.w3.org/2000/svg" width="1600" height="2040" viewBox="0 0 1600 2040" role="img" aria-labelledby="title desc">'
       ...
       '<desc id="desc">Approved Coform logo with a proposed carbon, chalk and stone palette without a color accent; Manrope and IBM Plex Mono; static editor and social cover concepts.</desc>'
       + ''.join(parts) + '</svg>')
