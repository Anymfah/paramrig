# ParamRig branding board — proposal 01
...
| Chalk | `#F4F3EB` | Light canvas |
| Stone | `#C8CCC0` | Supporting neutral |
| Signal | `#D8F36A` | Selection and primary creative actions |

Use Carbon text on Signal, not Signal body text on Chalk. This board is an sRGB
digital proposal; it does not claim CMYK or Pantone print equivalents.
